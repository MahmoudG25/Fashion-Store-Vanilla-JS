...
document.getElementById("cardholder").style.border = ""
...
document.getElementById("year").style.border = "2px solid red"
    ...
    if(cardholder.length < 5){document.getElementById("cardholder").style.border = "2px solid red";return}
    if(cardnumber.length!=16 || !isFinite(cardnumber)){document.getElementById("cardnumber").style.border= "2px solid red";return}
    if(month == "Month"){document.getElementById("month").style.border = "2px solid red";return}
    if(year == "Year"){document.getElementById("year").style.border = "2px solid red";return}
    if(cvc.length!=3 || !isFinite(cardnumber)){document.getElementById("cvc").style.border= "2px solid red";return}
  ...
  cvc: cvc
        ...
        if(document.getElementById("cardcheck").checked){
            window.localStorage.setItem(`${cardholder}`,paymentData)
        document.getElementsByClassName("containprogress")[0].innerHTML = "<br><br><br><h3 class='fade_in ;'>Your order is confirmed ✅</h3><br><br><a href='#shop' style='text-decoration:none; color:black'>Continue Shopping -></a>"
                    ...
                    // window.sessionStorage.setItem(`${cardholder}`,paymentData)
        document.getElementsByClassName("containprogress")[0].innerHTML = "<br><br><br><h3 class='fade_in ;'>Your order is confirmed ✅</h3><br><br><a href='#shop' style='text-decoration:none; color:black'>Continue Shopping -></a>"
    }}
